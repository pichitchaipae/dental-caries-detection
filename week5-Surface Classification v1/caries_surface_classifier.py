...
# The original PCA function is retained for reference, but the final version is more robust and uses OpenCV's PCACompute for better handling of edge cases and numerical stability.

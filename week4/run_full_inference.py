...
def main():
    ...
    OUTPUT_DIR = BASE_DIR / "week4" / "inference_full_500"
    MODEL_PATH = BASE_DIR / "week4" / "runs" / "caries_train" / "caries_3class" / "weights" / "best.pt"

"""
AIM XML Ground Truth Parser (week8 – re-export from week6)
==========================================================
...
_WEEK6_FILE = Path(__file__).resolve().parent.parent / "week6-Surface Classification v2" / "xml_ground_truth_parser.py"

"""
SNODENT-to-FDI Tooth Mapping (week8 – identical to week6)
=========================================================
Re-exported here so week8 modules can import locally.
...
_WEEK6_FILE = Path(__file__).resolve().parent.parent / "week6-Surface Classification v2" / "snodent_tooth_map.py"

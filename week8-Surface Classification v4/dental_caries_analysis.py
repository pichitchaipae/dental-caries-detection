"""
Dental Caries Analysis Pipeline — week8 (inherited from week7)
================================================================================

Identical to week7 with updated output paths for week8.

Fixes from week7:
  Task 2 – Boundary Leakage (morphological erosion + size threshold)
  Task 3 – Unassigned Caries (missing upstream teeth fallback)
...
# =============================================================================
# Task 3 FIX – Detect Unassigned Caries Blobs
# =============================================================================
...
def process_single_case(case_num, json_dir, roi_dir, output_dir):
    ...
    case_output_dir = Path(output_dir) / "cases" / f"case {case_num}"
...
def process_all_cases(json_dir, roi_dir, output_dir, num_cases=500):
    ...
    print("=" * 70)
    print("Dental Caries Analysis Pipeline – week8 (with Erosion + Unassigned)")
    print("=" * 70)
...
def main():
    parser = argparse.ArgumentParser(
        description="Dental Caries Analysis Pipeline – week8 (Erosion + Unassigned Caries)"
    )
    ...
    json_dir = base_dir / "week2-Tooth Detection & Segmentation" / "500-segmentation+recognition"
    roi_dir  = base_dir / "raw_data" / "500-roi"
    output_dir = base_dir / "week8-Surface Classification v4" / "dental_analysis_output"

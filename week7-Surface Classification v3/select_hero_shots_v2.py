...
EVAL_CSV      = BASE_DIR / "week7-Surface Classification v3" / "evaluation_output" / "evaluation_results.csv"
DASHBOARD_DIR = BASE_DIR / "week7-Surface Classification v3" / "dental_analysis_output"
OUTPUT_DIR    = BASE_DIR / "week7-Surface Classification v3" / "hero_shots"
...
def cat4_missing_upstream(df: pd.DataFrame, n: int = 5) -> list[dict]:
    ...
    for _, row in fn.iterrows():
        ...
        gt = str(row.get("gt_surface_norm", "Unclassified"))

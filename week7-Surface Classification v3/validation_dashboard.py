...
from matplotlib.patches import Polygon as MplPolygon, FancyBboxPatch # type: ignore
...
WEEK3_DIR          = BASE_DIR / "week3-Caries-to-Tooth Mapping" / "dental_analysis_output"   # fallback
OUTPUT_DIR         = BASE_DIR / "week7-Surface Classification v3" / "dental_analysis_output"   # output
